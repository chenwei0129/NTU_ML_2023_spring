...
Original file is located at
    https://colab.research.google.com/drive/1-JGLbl8V5kERP6du3O7CQlrqKn8rsm_E
"""
...
class LSTMnet(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_layer, n_class):
        ...
        self.lstm = nn.LSTM(in_dim, 300, 3, batch_first=True, dropout=0.6, bidirectional=True)
        self.fc = nn.Sequential(
            BasicBlock(600, hidden_dim),
...
del train_X, train_y, val_X, val_y#, val_X_1, val_y_1
gc.collect()
...
# load data
test_X = preprocess_data(split='test', feat_dir='./libriphone/feat', phone_path='./libriphone', concat_nframes=concat_nframes, random_seed=seed)
